...
class multi_modal_model(nn.Module):
    ...
    def forward(self, text_feature, video_feature, attention_mask, segment_mask, mask_lm_labels):
        ...
        out = self.bert_model(inputs_embeds=input_feature, attention_mask=attention_mask, token_type_ids=segment_mask,masked_lm_labels=mask_lm_labels)
        return out