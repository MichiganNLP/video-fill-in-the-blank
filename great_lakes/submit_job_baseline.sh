...
echo Sourced
python -u /home/liunan/LifeQA-methodology/baseline_BOW_VF.py -v --data-path /scratch/mihalcea_root/mihalcea1/shared_data/ActivityNet_Captions --epochs 1000 > /home/liunan/LifeQA-methodology/train.txt
echo done